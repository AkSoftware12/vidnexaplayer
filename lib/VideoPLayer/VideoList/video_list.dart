...
class _VideoFolderScreenState extends State<VideoFolderScreen> {
  ...
  // Future<String> _getVideoInfo(File video) async {
  //   final controller = VideoPlayerController.file(video);
  //   await controller.initialize();
  //   final size = controller.value.size;
  //
  //   String resolution = "${size.width.toInt()}x${size.height.toInt()}";
  //   String quality = size.height >= 720 ? "HD" : "Normal";
  //   String fileSize =
  //   (video.lengthSync() / (1024 * 1024)).toStringAsFixed(2);
  //
  //   await controller.dispose();
  //   return "$fileSize MB | $quality | $resolution";
  // }
                  ...
                  FutureBuilder<String?>(
                    ...
                    builder: (context, snapshot) {
                      return snapshot.hasData && snapshot.data != null
                          ? Stack(
                              alignment:
                                  Alignment.center, // Center the play icon
                              children: [
                                ClipRRect(
                                ...
                                // Play icon at the center
                                Icon(
                                  Icons.play_circle_filled,
                                  size: 30.sp,
                                  color: Colors.white.withOpacity(
                                      0.8), // Semi-transparent white for visibility
                                ),
                                // Time text at bottom-right
                                Positioned(
                                  bottom: 4,
                                  right: 4,
                                  child: Container(
                          ...
                          : Container(
                              ...
                              child: Center(
                                child:Icon(
                                  Icons.play_circle_filled,
                                  size: 30.sp,
                                  color: ColorSelect.maineColor, // Semi-transparent white for visibility
                                ),
                              ),
                            );
                    },
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          ...
          child: Card(
            elevation: 2,
            // shadowColor: ColorSelect.maineColor, // Yaha aap shadow ka color set kar sakte ho
            shape: RoundedRectangleBorder(
                          ...
                          ? Stack(
                              ...
                              children: [
                                ...
                                Icon(
                                  Icons.play_circle_filled,
                                  size: 45.sp,
                                  color: Colors.white.withOpacity(0.8), // Semi-transparent white for visibility
                                ),
                                // Time text at bottom-right
                                Positioned(
                                  bottom: 2,
