...
class _HomeBottomNavigationState extends State<HomeBottomNavigation> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //                   onTap: () {
      //                     setState(() {
      //                       currentPage = 1; // Update the current page
      //                     });
      //                     bottomNavigationKey.currentState?.setState(() {
      //                       bottomNavigationKey.currentState?._currentIndex = 1; // Sync bottom bar index
      //                     });
      //                     // widget.onTabChangedListener(1); // Notify the listener
      ...
      //                     });
      //                     bottomNavigationKey.currentState?.setState(() {
      //                       bottomNavigationKey.currentState?._currentIndex = 2; // Sync bottom bar index
      //                     });
      //                     // widget.onTabChangedListener(1); // Notify the listener
      //                     Navigator.of(context).pop(); // Close the drawer
      //                   },
